...
Palette.prototype.calcIntervals = function(input) {
	var out = [];
...
Palette.prototype.calcIntervalsR = function(input) {
	var out = [];
	var mod = 255 - input;
...
Palette.prototype.setSteps = function(steps) {
	if (steps < 2) return false;
	currentSteps = steps;
	return true;
};

Palette.prototype.setEditable = function(RGB) {
...
Palette.prototype.setHarshness = function(harshness) {
	while (harshness > 1) harshness = harshness / 10;
	harsh = harshness;
	return true;
};

Palette.prototype.getBase = function() {
	return currentBaseColor;
};

Palette.prototype.getSteps = function() {
	return currentSteps;
};

Palette.prototype.getChangeable = function() {
	return changeableRGB;
};

Palette.prototype.getHarshness = function() {
	return harsh;
};

Palette.prototype.getColorsAt = function(index) {
...
Palette.prototype.nextColors = function() {
...
Palette.prototype.nextColorsR = function() {
	if (currentColors != null) previousColors[previousColors.length] = (currentColors);
	var tempColor = reorderHex(currentBaseColor, changeableRGB);
...
Palette.prototype.nextPurification = function() {
	if (currentColors != null) previousColors[previousColors.length] = (currentColors);
	currentColors = [];
	var tempColor = reorderHex(currentBaseColor, changeableRGB);
...
Palette.prototype.nextShades = function() {
	if (currentColors != null) previousColors[previousColors.length] = (currentColors);
	currentColors = [];
